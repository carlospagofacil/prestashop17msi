...
class Pagofacil extends PaymentModule
{
    ...
    public function __construct()
    {
        ...
        // Own Config
        $this->urls = [
            'https://sandbox.pagofacil.tech/',
            'https://api.pagofacil.tech/'
        ];
    ...
    protected function updateValuesPagoFacil()
    {
        ...
        $pf_id_ecommerce = empty($this->getValueConfig('PF_ID_ECOMMERCE')) ? 'Prestashop Api' : $this->getValueConfig('PF_ID_ECOMMERCE');
    ...
    protected function getValuesPagoFacil()
    {
        return [
            ...
            'PF_ID_ECOMMERCE' => Configuration::get('PF_ID_ECOMMERCE'),
